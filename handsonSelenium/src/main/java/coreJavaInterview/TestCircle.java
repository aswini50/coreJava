...
public class TestCircle {  // Save as "TestCircle.java"
   public static void main(String[] args) {
      ...
      System.out.println("The circle has radius of " 
         + c2.getRadius() + " and area of " + c2.getArea() + " color being : " + c2.getColor());
      ...
      // with the given radius and give color.
      
      Circle c3 = new Circle(4,"white");
      System.out.println("The circle has radius of " 
    	         + c3.getRadius() + " and area of " + c3.getArea() + " color being : " + c3.getColor() );
      ...
      System.out.println("radius is: " + c4.getRadius()); // Print radius via constructor
      System.out.println("color is: " + c4.getColor());   // Print color via constructor
